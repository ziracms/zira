...
class Categorymeta extends Form
{
    protected $_id = 'dash-categorymeta-form';
    ...
    protected function _render()
    {
        ...
        $html .= $this->input(Locale::t('Description'), 'meta_description');
        $html .= $this->close();
        return $html;
    }
    ...
    protected function _validate()
    {
        ...
        $validator->registerString('meta_description', null, 255, false, Locale::t('Invalid value "%s"',Locale::t('Description')));
