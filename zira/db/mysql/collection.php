...
//            }
            ...
            $this->_update []= Db::escapeIdentifier($alias).'.'.Db::escapeIdentifier($field). ' = ?';
    ...
    public function toString() {
        ...
        if (!empty($this->_update)) {
            $query .= 'UPDATE ';
            $query .= Db::escapeIdentifier($this->_table) . ' AS ' . Db::escapeIdentifier($this->_alias);
            $query .= ' SET ' . implode(', ', $this->_update);
        } else if ($this->_delete) {
            $query .= 'DELETE '.Db::escapeIdentifier($this->_alias).' FROM ';
