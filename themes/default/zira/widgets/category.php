...
<?php if (!empty($url)): ?>
<h2 class="widget-category-title"><a href="<?php echo Zira\Helper::html(Zira\Helper::baseUrl($url)) ?>" title="<?php echo Zira\Helper::html($title) ?>"><?php echo Zira\Helper::html($title) ?></a></h2>
<?php else: ?>
